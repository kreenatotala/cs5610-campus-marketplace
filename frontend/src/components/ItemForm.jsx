...
function ItemForm({ item, onSubmit, onCancel }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="item-form">
      ...
      <input name="building" value={formData.building} onChange={handleChange} placeholder="Building" required />
      <input name="distance" type="number" value={formData.distance} onChange={handleChange} placeholder="Distance (mi)" required />
